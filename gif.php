<?php use dependenci\clases\AnimatedGif as AnimatedGif;
require_once('vendor/autoload.php');
include 'dependenci/includes/php52-fix.php';
	...
	$font = array(
		...
		'file' => __DIR__ . DIRECTORY_SEPARATOR . 'fonts/Futura.ttc', // Font path
